...
from model import MSDT as myNet
import losses
...
parser.add_argument('--train_dir', default='/home/user/data/21/chm/dataset/Rain200H/Rain200H/train', type=str, help='Directory of train images')
parser.add_argument('--val_dir', default='/home/user/data/21/chm/dataset/Rain200H/Rain200H/test', type=str, help='Directory of validation images')
